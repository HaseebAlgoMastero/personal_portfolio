import notFoundPoster from '~/assets/hero.png';
import notFoundVideo from '~/assets/uses-background.mp4';
import flatlinePoster from '~/assets/uses-background-placeholder.jpg';
import flatlineVideo from '~/assets/uses-background.mp4';
